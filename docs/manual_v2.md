...
[Dokumentet — öppna teamets dokument](../../../../goencoder-dev-team/teams/iloppis/docs/history/obsolete.md).

Kanonisk sökväg i `goencoder-dev-team`: `teams/iloppis/docs/history/obsolete.md`.
