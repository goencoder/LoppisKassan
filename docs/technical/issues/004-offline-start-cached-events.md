...
[Issue 048 — öppna teamets dokument](../../../../../../goencoder-dev-team/teams/iloppis/docs/issues/048-offline-start-cached-events.md).

Kanonisk sökväg i `goencoder-dev-team`: `teams/iloppis/docs/issues/048-offline-start-cached-events.md`.
