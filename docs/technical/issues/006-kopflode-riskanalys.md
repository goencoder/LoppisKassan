...
[Issue 067 — öppna teamets dokument](../../../../../../goencoder-dev-team/teams/iloppis/docs/issues/067-kopflode-riskanalys.md).

Kanonisk sökväg i `goencoder-dev-team`: `teams/iloppis/docs/issues/067-kopflode-riskanalys.md`.
